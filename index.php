...
<!-- 		<script src="js/jquery.svgdom.js" type="text/javascript" language="javascript" ></script>
	...
	<body>
		...
		<div id="sur-body">
			...
			<div id="head" style="background-color: <?php echo $site->couleur;?>">
			...
			<div id="filariane">Vous êtes ici : <?php echo $site->getFilAriane();?></div>
			<div id="content">
			<div id="tooltip"></div>
			...
			<div id="foot" style="background-color: <?php echo $site->couleur;?>">
			<?php echo $site->getFoot();?>
			</div>

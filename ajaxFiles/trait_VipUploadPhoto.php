...
class qqFileUploader {
    ...
    private function checkServerSettings(){        
        ...
        if ($postSize < $this->sizeLimit || $uploadSize < $this->sizeLimit){
            ...
            die("{'error':'increugmenter les variables d\'initialisation post_max_size et upload_max_filesize à $size'}");    
        }        
    }
 ...
 */
	...
	$dos = strtolower('vipupload');
	
	if(!is_dir('images/vipupload')) {
		mkdir(strtolower('images/vipupload'),0777);
	}
	...
	$result = $uploader->handleUpload('images/vipupload/');
